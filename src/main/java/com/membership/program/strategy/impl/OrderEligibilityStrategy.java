...
@Component
public class OrderEligibilityStrategy implements TierEligibilityStrategy {

    @Override
    public boolean isEligible(UserProfile userProfile,OrderSummary orderSummary,
                              MembershipTier membershipTier) {

        return orderSummary.getTotalOrdersThisMonth() >= membershipTier.getMinOrders();
    }
}
